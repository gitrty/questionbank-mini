<template>
  <view class="answer">
    ...
    <view class="answer-top">
      <view class="answer-left" @tap="tabBar=0">
        <text :class="{'active':tabBar===0}">大厂面试</text>
      </view>
      <view class="answer-middle" @tap="tabBar=1">
        <text :class="{'active':tabBar===1}">专题练习</text>
      </view>
      <view class="answer-right" @tap="tabBar=2">
        <text :class="{'active':tabBar===2}">错题集</text>
      </view>
    </view>

    <!-- 大厂面试 -->
    <view class="BF-bgc" v-show="tabBar===0">
      <toyoAnswercard :bigFactoryList="bigFactoryList" :type="'examination'"></toyoAnswercard>
    </view>
    ...
    <view class="BF-bgc" v-show="tabBar===1">
      ...
      <toyoAnswercard :bigFactoryList="exercisesList" :type="'practice'"></toyoAnswercard>
    </view>
    <!-- 错题集 -->
    <toyoSubject :subjectList="subjectList" v-if="tabBar===2"></toyoSubject>
    <!-- 无相关答题 -->
    <toyoNoinfo :type="'答题'" :imgSrc="'/static/no-quest.png'" v-if="!bigFactoryList.length&&!tabBar||!exercisesList.length&&tabBar===1||!subjectList.length&&tabBar===2"></toyoNoinfo>
  </view>
</template>
