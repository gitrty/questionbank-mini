...
/* 7 */
/*!************************************************!*\
  !*** E:/GPer/GPer/pages.json?{"type":"style"} ***!
  \************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 8 */
/*!***********************************************!*\
  !*** E:/GPer/GPer/pages.json?{"type":"stat"} ***!
  \***********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "appid": "__UNI__7684F53" };exports.default = _default;
  ...
  install: function install(Vue) {
    Vue.mixin({
      methods: {
        ...
        // 关闭当前页，跳转到指定页
        redirectTo: function redirectTo(url) {var data = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';
          if (data) url += urlLoader(data);
          uni.redirectTo({
            url: url });
        ...
        // 回退页面
        navigateBack: function navigateBack() {var delta = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 1;
          uni.navigateBack({
            delta: delta });

        },
        showModel: function () {var _showModel = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var _ref, confirm;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:_context.next = 2;return (


                      _http.util.showModal({
                        title: "温馨提示",
                        content: "是否跳转授权登录" }));case 2:_ref = _context.sent;confirm = _ref.confirm;return _context.abrupt("return",

                    confirm);case 5:case "end":return _context.stop();}}}, _callee, this);}));function showModel() {return _showModel.apply(this, arguments);}return showModel;}(),

        checkAuth: function () {var _checkAuth = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee2() {return _regenerator.default.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:if (
                    this.globalData.access_token) {_context2.next = 6;break;}_context2.next = 3;return (
                      this.showModel());case 3:if (!_context2.sent) {_context2.next = 5;break;}return _context2.abrupt("return", this.jump("/pages/arthorize/index"));case 5:return _context2.abrupt("return");case 6:return _context2.abrupt("return",


                    true);case 7:case "end":return _context2.stop();}}}, _callee2, this);}));function checkAuth() {return _checkAuth.apply(this, arguments);}return checkAuth;}(),
    ...
    // 数字转化为周
    Vue.filter('numToWeek', function (val) {
      if (val === 0) return '日';
      if (val === 1) return '一';
      if (val === 2) return '二';
      if (val === 3) return '三';
...
var utils = /*#__PURE__*/function () {function utils() {_classCallCheck(this, utils);}_createClass(utils, [{ key: "login", value: function login()
    ...
    scope) {
      return authorizes({ scope: scope });
    } }, { key: "getImageInfo", value: function getImageInfo(
    src) {
      return getImageInfos({ src: src });
    } }, { key: "saveImageToPhotosAlbum", value: function saveImageToPhotosAlbum(
    filePath) {
      return saveImageToPhotosAlbums({ filePath: filePath });
    } }, { key: "getUserInfo", value: function getUserInfo()
    {
      return getUserInfos();
    } }, { key: "requestPayment", value: function requestPayment(
    data) {
...
/* 23 */
/*!************************************!*\
  !*** E:/GPer/GPer/config/index.js ***!
  \************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.wxPromisify = void 0;
var wxPromisify = function wxPromisify(fn) {return function () {var obj = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};return new Promise(function (resolve, reject) {return obj.success = function (_) {
        resolve(_);
      },
      obj.fail = function (_) {
        resolve(null);
