...
var _selectTab = _interopRequireDefault(__webpack_require__(/*! ./pages/itembank/special/selectTab.vue */ 182));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/* harmony import */ var _selectTab_vue_vue_type_template_id_42d25abc_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./selectTab.vue?vue&type=template&id=42d25abc&scoped=true& */ 183);
/* harmony import */ var _selectTab_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./selectTab.vue?vue&type=script&lang=js& */ 185);
...
/* harmony import */ var _selectTab_vue_vue_type_style_index_0_id_42d25abc_scoped_true_lang_less___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./selectTab.vue?vue&type=style&index=0&id=42d25abc&scoped=true&lang=less& */ 187);
...
getLabelListByClassifyId = _api.itembank.getLabelListByClassifyId;var _default =
{
  data: function data() {
    return {
  ...
  onLoad: function () {var _onLoad = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee(e) {var labelList;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:_context.next = 2;return (
                getLabelListByClassifyId({ classifyId: e.classifyId }));case 2:labelList = _context.sent;
              labelList.forEach(function (item) {return item.isChecked = false;});
              this.labelList = labelList;case 5:case "end":return _context.stop();}}}, _callee, this);}));function onLoad(_x) {return _onLoad.apply(this, arguments);}return onLoad;}(),

  methods: {
    // 选择标签
    selectTag: function selectTag(labelId, labelName, index) {
      this.labelId = labelId;
      this.labelName = labelName;
      this.labelList.forEach(function (item) {return item.isChecked = false;});
      this.labelList[index].isChecked = true;
    },

    // 下一步
    nextBack: function nextBack() {
      if (!this.labelId) this.showToast('请选择标签');else
      this.jump('/pages/itembank/special/filtering', { labelId: this.labelId, labelName: this.labelName });
