...
var _filtering = _interopRequireDefault(__webpack_require__(/*! ./pages/itembank/special/filtering.vue */ 190));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/* harmony import */ var _filtering_vue_vue_type_template_id_5b5e12ad_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./filtering.vue?vue&type=template&id=5b5e12ad&scoped=true& */ 191);
/* harmony import */ var _filtering_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./filtering.vue?vue&type=script&lang=js& */ 193);
...
/* harmony import */ var _filtering_vue_vue_type_style_index_0_id_5b5e12ad_lang_less_scoped_true___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./filtering.vue?vue&type=style&index=0&id=5b5e12ad&lang=less&scoped=true& */ 195);
...
var _default =
{
  ...
  methods: {
    ...
    topicTypeClick: function topicTypeClick(index) {
      ...
      this.topicType.forEach(function (item) {return item.isChecked = false;});
    ...
    // 确认练习
    startEx: function startEx() {
      var biaoQianIdList = '-' + this.labelId + '-';
      var tiXin;
      var num;
      this.topicType.some(function (item) {return item.isChecked ? tiXin = item.name : 0;});
      this.topicNum.some(function (item) {return item.isChecked ? num = item.num : 0;});
